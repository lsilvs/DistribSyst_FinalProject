...
public class _AddressStub extends org.omg.CORBA.portable.ObjectImpl implements AddressBook.Address
{
  ...
  public void registerCB (AddressBook.AddressBookOps c, int userId)
  {
            ...
            try {
                ...
                AddressBook.AddressBookOpsHelper.write ($out, c);
  ...
  public void remove (org.omg.CORBA.Any addressAccountDetailsIn, org.omg.CORBA.AnyHolder addressAccountDetailsOut)
  {
            ...
            try {
                ...
                remove (addressAccountDetailsIn, addressAccountDetailsOut        );
            } finally {
                _releaseReply ($in);
            }
  } // remove
  ...
  public void displaysAvailableUsers ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("displaysAvailableUsers", true);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
